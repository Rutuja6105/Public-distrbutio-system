...
const initialBeneficiaries = [
  ...
  {
    id: 4,
    name: 'Vishwajeet Jadhav',
    cardNo: 'RC004',
    phone: '9405236511',
    queueNo: 7,
    status: 'pending',
    address: `${VILLAGE_NAME} Ward 4`,
    totalMembers: 6,
    cardType: 'orange',
    headAge: '40',
    headBirthDate: '1985-01-01',
    headGender: 'male',
    headIncome: '60000',
    headAadhaar: '423456789012',
    familyMembers: [{ name: 'V. J. Family', age: '30', birthDate: '1995-01-01', gender: 'female', occupation: 'Service', aadhaar: '423456789012' }]
  }
];
